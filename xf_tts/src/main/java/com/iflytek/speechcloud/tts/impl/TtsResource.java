...
public class TtsResource {
    ...
    public TtsResource(Context context, Intent resIntent) {
        this.mContext = context;
        this.mResFile = resIntent.getStringExtra(AiConstants.STANDERD_VOICE_NAME);
    ...
    public byte[] readResource(int offset, int length) {
        closeUnusedStream();
        if (AiConstants.DEFAULT_VOICE_RES.equals(this.mResFile)) {
